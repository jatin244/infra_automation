...
resource "aws_s3_bucket" "s3_default" {
  provider = aws.stack
  count    = var.create_bucket_enabled == true ? 1 : 0
...
resource "aws_s3_bucket_policy" "s3_default" {
  provider = aws.stack
  count    = var.create_bucket_enabled && var.bucket_policy && var.create_bucket_enabled == true ? 1 : 0
...
resource "aws_s3_bucket_accelerate_configuration" "example" {
  provider = aws.stack
  count    = var.create_bucket_enabled && var.acceleration_status == true ? 1 : 0
...
resource "aws_s3_bucket_request_payment_configuration" "example" {
  provider = aws.stack
  count    = var.create_bucket_enabled && var.request_payer == true ? 1 : 0
...
resource "aws_s3_bucket_versioning" "example" {
  provider = aws.stack
  count    = var.create_bucket_enabled && var.versioning == true ? 1 : 0
...
resource "aws_s3_bucket_logging" "example" {
  provider = aws.stack
  count    = var.create_bucket_enabled && var.logging == true ? 1 : 0
  bucket   = join("", aws_s3_bucket.s3_default.*.id)
...
resource "aws_s3_bucket_server_side_encryption_configuration" "example" {
  provider = aws.stack
  count    = var.create_bucket_enabled && var.enable_server_side_encryption == true ? 1 : 0
  bucket   = join("", aws_s3_bucket.s3_default.*.id)
...
resource "aws_s3_bucket_object_lock_configuration" "example" {
  provider = aws.stack
  count    = var.create_bucket_enabled && var.object_lock_configuration != null ? 1 : 0
...
resource "aws_s3_bucket_cors_configuration" "example" {
  provider = aws.stack
  count    = var.create_bucket_enabled && var.cors_rule != null ? 1 : 0
...
resource "aws_s3_bucket_website_configuration" "example" {
  provider = aws.stack
  count    = var.create_bucket_enabled && var.website_config_enable == true ? 1 : 0
...
resource "aws_s3_bucket_acl" "default" {
  ...
  count  = var.create_bucket_enabled ? var.grants != null ? var.acl != null ? 1 : 0 : 0 : 0
  bucket = join("", aws_s3_bucket.s3_default.*.id)
...
resource "aws_s3_bucket_lifecycle_configuration" "default" {
  provider = aws.stack
  count    = var.create_bucket_enabled && var.enable_lifecycle_configuration_rules == true ? 1 : 0
  bucket   = join("", aws_s3_bucket.s3_default.*.id)
...
resource "aws_s3_bucket_replication_configuration" "this" {
  provider = aws.stack
  count    = var.create_bucket_enabled && length(keys(var.replication_configuration)) > 0 ? 1 : 0
...
resource "aws_s3_bucket_public_access_block" "this" {
  provider = aws.stack
  count    = var.create_bucket_enabled && var.attach_public_policy ? 1 : 0
...
resource "aws_s3_bucket_ownership_controls" "this" {
  provider = aws.stack
  count    = var.create_bucket_enabled && var.control_object_ownership ? 1 : 0
