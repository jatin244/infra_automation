...
#Mention RDS snapshot available in product account if snapshot is to be used for RDS creation
#db_snapshot_identifier = "arn:aws:rds:us-east-1:366674262526:snapshot:fincore-mysqlappdb-master8023ci"

#Following are disregarded if RDS creation is being done from snapshot
mysql_engine_version    = "8.0.28"
mysql_allocated_storage = 150
