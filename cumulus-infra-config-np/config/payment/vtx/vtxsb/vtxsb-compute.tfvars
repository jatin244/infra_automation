#######################################################security-group#########################################################
eks_sg_cidr_blocks       = ["10.238.224.0/24", "10.238.72.0/24", "172.20.96.0/20", "10.155.1.0/24", "10.155.4.0/24", "10.254.141.0/24", "10.254.151.0/24", "172.20.112.0/20", "10.238.21.43/32"]
...
ssh_sg_cidr_blocks       = ["10.238.224.0/24", "10.238.72.0/24", "172.20.96.0/20", "10.155.1.0/24", "10.155.4.0/24", "10.254.141.0/24", "10.254.151.0/24", "172.20.112.0/20"]
etcd_ec2_sg_cidr_blocks  = ["10.238.224.0/24", "10.238.72.0/24", "172.20.96.0/20", "10.155.1.0/24", "10.155.4.0/24", "10.254.141.0/24", "10.254.151.0/24", "172.20.112.0/20"]
...
eks_allowed_cidr_blocks_cluster = ["10.238.224.0/24", "10.238.72.0/24", "172.20.96.0/20", "10.155.1.0/24", "10.155.4.0/24", "10.254.141.0/24", "10.254.151.0/24", "172.20.112.0/20", "10.238.21.43/32"]
...
schema_registries = {
  vortex = {
    name        = "vtxsb"
    description = "Schema registry for vortex Sandbox environment"
  }
}
schemas = {
  vortex = {
    ...
    schema_name          = "vtxsb"
    description          = "Schema that contains all the Vortex Sandbox data"
